    ...
    : myMainWindow{parent}
{
    ...
    for(int i=0;i<20;i++)
    {
        ...
        connect(btn,&Mypushbutton::clicked,[=](){
            ...
            sound->setSource(QUrl::fromLocalFile(":/C:/Users/2814554384/Desktop/res/TapButtonSound.wav"));
            sound->play();
            ...
            connect(play,&playscene::backBtnclick,[=](){
                QSoundEffect* sound=new QSoundEffect(this);
                sound->setSource(QUrl::fromLocalFile(":/C:/Users/2814554384/Desktop/res/BackButtonSound.wav"));
                sound->play();
                this->show();
                play->close();
                this->move(play->pos());
