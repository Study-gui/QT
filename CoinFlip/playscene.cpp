...
void playscene::filp(int row, int col)
{
    ...
    sound->setSource(QUrl::fromLocalFile(":/C:/Users/2814554384/Desktop/res/ConFlipSound.wav"));
    sound->play();
    //点击就翻转
...
void playscene::judgewin()
{
    ...
    this->mHaswin=true;
    QSoundEffect* sound=new QSoundEffect(this);
    sound->setSource(QUrl::fromLocalFile(":/C:/Users/2814554384/Desktop/res/LevelWinSound.wav"));
    sound->play();
